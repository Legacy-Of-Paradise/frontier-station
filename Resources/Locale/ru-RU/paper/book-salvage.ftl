...
book-text-demonomicon2 =
    ...
    2. СТоп. Опечатка. Черт. Простите чуваки
...
book-text-chemistry-insane =
    ...
    МОЙ СОВЕТ НОМЕР ОДИН. ВСЕГДА ВЕСЕЛИСЬ. НИКОГДА НЕ ЗНАЕШЬ, КОГДА ВСЕ ЗАКОНЧИТСЯ.
...
book-text-botanics = ** Практическое применение образцов флоры, встречаемых на территориях Nanotrasen **
    ...
    Многие растения, будучи измельченными, образуют полезные химические вещества. К. (тут и далее - космический) мак и к. алоэ вера
...
book-text-gnome =
    ...
    Сраженный злопыхателями, не способными признать наш род!
...
book-text-detective =
    ...
    Я был на Багеле, играл в мяч, когда услышал вскрик и лазерный выстрел. Я зашел под стоящий рядом стол, намереваясь спрятаться, но второго выстрела не прозвучало.
    ...
    Здесь всегда все идет наперекосяк... Я никогда больше не буду относиться к клоунам как раньше.

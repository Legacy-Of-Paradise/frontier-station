...
head-rev-role-greeting =
    Вы - глава революции.
    Вам поручено устранить весь командный состав станции путем убийства, изгнания за борт, или ареста.
...
rev-role-greeting =
    ...
    Viva la revolución!
rev-briefing = Помогите главам революции избавиться от командования станции, чтобы захватить ее.

...
ent-SupermatterGrenade = граната суперматерии
    .desc = Граната, имитирующая расслоение сверхматерии двигателя, притягивает все в кучу и через некоторое время взрывается.
ent-WhiteholeGrenade = граната белой дыры
    .desc = Граната, которая некоторое время отталкивает все вокруг.
ent-NuclearGrenade = критическая масса
    .desc = Пожалуйста не бросай ее, подумай о детях.
...
ent-MetalFoamGrenade = металопенная граната
    .desc = Аварийное приспособление, используемое для заделывания пробоин. Почти так же надежно, как настоящие стены.

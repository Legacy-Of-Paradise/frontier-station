...
ent-StationRecordsComputerCircuitboard = консоль станционного учета (консольная плата)
    .desc = Консольная плата для консоли станционного учета.
...
ent-ComputerMassMediaCircuitboard = консоль управления новостями (консольная плата)
    .desc = Отправьте свое послание миру!

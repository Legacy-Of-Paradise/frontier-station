...
ent-ChemistryPDA = КПК химика
    .desc = На нем есть несколько обесцвеченных пятен.
...
ent-ERTEngineerPDA = КПК инженера ОБР
    .suffix = Инженер
    .desc = Красный значит мощный. Он изрядно потрепан.
...
ent-ERTSecurityPDA = КПК офицера безопасности ОБР
    ...
    .desc = Красный значит мощный. На боку нацарапаны метки подсчета.
...
ent-DetectivePDA = КПК детектива
    .desc = Пахнет дождем... хлещущим по крышам...

...
ent-DrinkChampagneBottleFull = бутылка шампанского
    .desc = Только люди, обделенные воображением, не могут найти оправдание шампанскому.
...
ent-DrinkMelonLiquorBottleFull = дынный ликер Эмеральдин
    .desc = Бутылка 23-градусного Дынного ликера Эмеральдин. Сладкий и легкий.
ent-DrinkPatronBottleFull = бутылка Покровитель в художественной обертке
...
ent-DrinkCreamCartonXL = молочные сливки XL
    .desc = Это сливки. Сделанные из молока. Что еще вы ожидали здесь найти?
...
ent-DrinkGreenTeaJug = кувшин зеленого чая
    .desc = Это как чай... только зеленый! Отлично успокаивает желудок.

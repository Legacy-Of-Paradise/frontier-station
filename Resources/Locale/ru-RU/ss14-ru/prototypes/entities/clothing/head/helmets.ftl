...
ent-ClothingHeadHelmetBombSuit = саперный шлем
...
ent-ClothingHeadHelmetJanitorBombSuit = саперно-уборочный шлем
...
ent-ClothingHeadHelmetFire = пожарный шлем
    .desc = Лучший друг борцов с огнем. Обеспечивает определенную жаростойкость и выглядит круто.
...
ent-ClothingHeadHelmetERTJanitor = шлем уборщика ОБР
    .desc = Атмосферный шлем, который носят уборщики отрядов быстрого реагирования Nanotrasen. Имеет темно-фиолетовый фонарь.
...
ent-ClothingHeadHelmetJustice = шлем правосудия
    .desc = Продвинутое снаряжение службы безопасности. Защищает станцию от никчемных сотрудников.

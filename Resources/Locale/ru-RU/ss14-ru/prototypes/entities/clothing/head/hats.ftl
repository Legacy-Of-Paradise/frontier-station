...
ent-ClothingHeadHatSecurityTrooper = шляпа патрульного
    .desc = Широкополая шляпа Патрульных Nanotrasen, идет в комплекте с чехлом, но вы его потеряли.
ent-ClothingHeadHatCasa = каса
    .desc = Конусообразная шляпа.
ent-ClothingHeadHatBeretRND = берет ученого
...
ent-ClothingHeadHatOutlawHat = шляпа негодяя
    .desc = Шляпа, в которой вы выглядите словно носите пистолет с одной и еще девятнадцатью зарубками.
...
ent-ClothingHeadHatSurgcapGreen = хирургическая шапочка
    .desc = Зеленая шапочка, которую хирурги надевают на операции. Не дает их волосам щекотать ваши внутренние органы.
...
ent-ClothingHeadPyjamaSyndicateBlack = синдикатно-черная пижамная шапочка
...
ent-ClothingHeadHatPartyYellow = желтый праздничный колпак
    .desc = { ent-ClothingHeadHatPartyRed.desc }
ent-ClothingHeadHatPartyGreen = зеленый праздничный колпак
    .desc = { ent-ClothingHeadHatPartyRed.desc }

...
ent-WallReinforced = укрепленная стена
    .desc = { ent-BaseWall.desc }
ent-WallReinforcedRust = { ent-WallReinforced }
    .suffix = Ржавый
    .desc = { ent-WallReinforced.desc }
ent-WallReinforcedDiagonal = укрепленная стена
    .suffix = Диагональ
    .desc = { ent-WallShuttleDiagonal.desc }
ent-WallRiveted = клепаная стена
    .desc = { ent-BaseWall.desc }
...
ent-WallMining = шахтерская стена
    .desc = { ent-BaseWall.desc }
ent-WallMiningDiagonal = шахтерская стена
    .suffix = Диагональ
    .desc = { ent-WallShuttleDiagonal.desc }

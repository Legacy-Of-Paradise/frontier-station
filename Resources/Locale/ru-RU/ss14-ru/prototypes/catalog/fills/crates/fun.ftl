...
ent-CrateFunInstrumentsString = набор струнных инструментов
    .desc = Ударяйте или щипайте, дергайте или бейте по струнам! Играйте нежные мелодии или крушите лица благодаря этому набору струнных инструментов.
...
ent-CrateFunSadTromboneImplants = ящик имплантов Грустный тромбон
    .desc = Умирать еще никогда не было так весело! Имплантируйте его, чтобы сделать смерть немного ярче.
...
ent-CrateFunBikeHornImplants = ящик хонк-имплантов
    .desc = Тысяча гудков за день отпугнет СБ на день!

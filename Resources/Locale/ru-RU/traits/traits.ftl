...
trait-wheelchair-bound-name = Привязанность к инвалидной коляске
trait-wheelchair-bound-desc = Вы не можете двигаться без инвалидной коляски. Она идёт в комплекте.
